...
var d = a.data(this, c);
if (!d) throw "cannot call methods on " + c + " prior to initialization; " + "attempted to call method '" + e + "'";
if (!a.isFunction(d[e])) throw "no such method '" + e + "' for " + c + " widget instance";
var f = d[e].apply(d, g);
...
var b = {};
return a.metadata && (b = a.metadata.get(element)[this.widgetName]), b;
},
_create: function() {},
_init: function() {},
destroy: function() {
...
function f() {
var b = c.width(), f = "min-width-", g = "max-width-", h = [], i = [], j = "px", k;
d.removeClass(f + e.join(j + " " + f) + j + " " + g + e.join(j + " " + g) + j), a.each(e, function(a, c) {
b >= c && h.push(f + c + j), b <= c && i.push(g + c + j);
}), h.length && (k = h.join(" ")), i.length && (k += " " + i.join(" ")), d.addClass(k);
}
var c = a(window), d = a("html"), e = [ 320, 480, 768, 1024 ];
...
f.type = "text/css", f.styleSheet ? f.styleSheet.cssText = g : f.appendChild(document.createTextNode(g)), d.prepend(e).prepend(f), b[a] = c.css("position") === "absolute", e.add(f).remove();
}
return b[a];
};
}(), a.mobile.addResolutionBreakpoints = function(b) {
a.type(b) === "array" ? e = e.concat(b) : e.push(b), e.sort(function(a, b) {
return a - b;
}), f();
}, a(document).bind("mobileinit.htmlclass", function() {
c.bind("orientationchange.htmlclass resize.htmlclass", function(a) {
a.orientation && d.removeClass("portrait landscape").addClass(a.orientation), f();
});
}), a(function() {
...
for (var g in f) if (d[g] !== b) return !0;
}
function i() {
var b = location.protocol + "//" + location.host + location.pathname + "ui-dir/", d = a("head base"), e = null, f = "";
d.length ? f = d.attr("href") : d = e = a("<base>", {
href: b
}).appendTo("head");
var g = a("<a href='testurl'></a>").prependTo(c), h = g[0].href;
return d[0].href = f ? f : location.pathname, e && e.remove(), h.indexOf(b) === 0;
}
var c = a("<body>").prependTo("html"), d = c[0].style, e = [ "webkit", "moz", "o" ], f = window.palmGetResource || window.PalmServiceBridge, g = window.blackberry;
...
cssPseudoElement: !!h("content"),
boxShadow: !!h("boxShadow") && !g,
scrollTop: ("pageXOffset" in window || "scrollTop" in document.documentElement || "scrollTop" in c[0]) && !f,
dynamicBaseTag: i(),
...
function x(b, c) {
var e = b.type;
b = a.Event(b), b.type = c;
var f = b.originalEvent, g = a.event.props;
if (f) for (var i = g.length, j; i; ) j = g[--i], b[j] = f[j];
if (e.search(/^touch/) !== -1) {
var k = w(f), e = k.touches, l = k.changedTouches, m = e && e.length ? e[0] : l && l.length ? l[0] : d;
if (m) for (var i = 0, n = h.length; i < n; i++) {
var j = h[i];
b[j] = m[j];
}
}
...
while (d && d.length) {
var f = d.data(e);
for (var g in f) f[g] && (c[g] = c.hasVirtualBinding = !0);
d = d.parent();
}
return c;
}
...
function A() {
i.touchbindings || (t.bind("touchend", L).bind("touchmove", K).bind("scroll", J), i.touchbindings = 1);
}
function B() {
i.touchbindings && (t.unbind("touchmove", K).unbind("touchend", L).unbind("scroll", J), i.touchbindings = 0);
}
function C() {
v = 0, p.length = 0, q = !1, B();
}
function D() {
A();
}
...
var f = x(c, b);
a(c.target).trigger(f), e = f.isDefaultPrevented();
}
return e;
}
function H(b) {
var c = a(b.target).data(f);
!q && (!v || v !== c) && G("v" + b.type, b);
}
function I(c) {
var d = w(c).touches;
if (d && d.length === 1) {
var e = c.target, g = y(e);
if (g.hasVirtualBinding) {
v = u++, a(e).data(f, v), F(), D(), o = !1;
var h = w(c).touches[0];
k = h.pageX, l = h.pageY, r && (m = b.pageXOffset, n = b.pageYOffset), G("vmouseover", c, g), G("vmousedown", c, g);
}
}
}
function J(a) {
o || G("vmousecancel", a, y(a.target)), o = !0, E();
}
function K(c) {
var d = w(c).touches[0], e = o, f = a.vmouse.moveDistanceThreshold;
o = o || r && (m !== b.pageXOffset || n !== b.pageYOffset) || Math.abs(d.pageX - k) > f || Math.abs(d.pageY - l) > f;
var g = y(c.target);
o && !e && G("vmousecancel", c, g), G("vmousemove", c, g), E();
}
function L(a) {
B();
var b = y(a.target);
...
M(g) || g.data(e, {});
var h = g.data(e);
h[b] = !0, i[b] = (i[b] || 0) + 1, i[b] === 1 && t.bind(c, H), g.bind(c, N), s && (i.touchstart = (i.touchstart || 0) + 1, i.touchstart === 1 && t.bind("touchstart", I));
},
teardown: function(d, f) {
--i[b], i[b] || t.unbind(c, H), s && (--i.touchstart, i.touchstart || t.unbind("touchstart", I));
var g = a(this), h = g.data(e);
h[b] = !1, g.unbind(c, N), M(g) || g.removeData(e);
}
};
}
var e = "virtualMouseBindings", f = "virtualTouchID", g = "vmouseover vmousedown vmousemove vmouseup vclick vmouseout vmousecancel".split(" "), h = "clientX clientY pageX pageY screenX screenY".split(" "), i = {}, j = 0, k = 0, l = 0, m = 0, n = 0, o = !1, p = [], q = !1, r = a.support.scrollTop, s = a.support.eventCapture, t = a(c), u = 1, v = 0;
a.vmouse = {
moveDistanceThreshold: 10,
clickDistanceThreshold: 10,
resetTimerDuration: 1500
};
for (var P = 0; P < g.length; P++) a.event.special[g[P]] = O(g[P]);
s && c.addEventListener("click", function(b) {
var c = p.length, d = b.target;
if (c) {
var e = b.clientX, g = b.clientY, h = a.vmouse.clickDistanceThreshold, i = d;
while (i) {
for (var j = 0; j < c; j++) {
var k = p[j], l = 0;
if (i === d && Math.abs(k.x - e) < h && Math.abs(k.y - g) < h || a(i).data(f) === k.touchID) {
...
a.each("touchstart touchmove touchend orientationchange tap taphold swipe swipeleft swiperight scrollstart scrollstop".split(" "), function(b, c) {
a.fn[c] = function(a) {
return a ? this.bind(c, a) : this.trigger(c);
}, a.attrFn[c] = !0;
});
var c = a.support.touch, d = "touchmove scroll", e = c ? "touchstart" : "mousedown", f = c ? "touchend" : "mouseup", g = c ? "touchmove" : "mousemove";
a.event.special.scrollstart = {
enabled: !0,
setup: function() {
function g(a, c) {
e = c, h(b, e ? "scrollstart" : "scrollstop", a);
}
var b = this, c = a(b), e, f;
c.bind(d, function(b) {
if (!a.event.special.scrollstart.enabled) return;
e || g(b, !0), clearTimeout(f), f = setTimeout(function() {
g(b, !1);
}, 50);
});
}
...
setup: function() {
var b = this, c = a(b);
c.bind("vmousedown", function(a) {
function i() {
d = !1, clearTimeout(g), c.unbind("vclick", j).unbind("vmousecancel", i);
}
function j(a) {
i(), e == a.target && h(b, "tap", a);
}
if (a.which && a.which !== 1) return !1;
var d = !0, e = a.target, f = a.originalEvent, g;
c.bind("vmousecancel", i).bind("vclick", j), g = setTimeout(function() {
d && h(b, "taphold", a);
}, 750);
});
}
...
}, Math.abs(h.coords[0] - i.coords[0]) > 10 && a.preventDefault();
}
var e = c.originalEvent.touches ? c.originalEvent.touches[0] : c, h = {
time: (new Date).getTime(),
coords: [ e.pageX, e.pageY ],
origin: a(c.target)
}, i;
d.bind(g, j).one(f, function(a) {
d.unbind(g, j), h && i && i.time - h.time < 1e3 && Math.abs(h.coords[0] - i.coords[0]) > 30 && Math.abs(h.coords[1] - i.coords[1]) < 75 && h.origin.trigger("swipe").trigger(h.coords[0] > i.coords[0] ? "swipeleft" : "swiperight"), h = i = b;
});
});
}
}, function(a) {
function f() {
var a = d();
a !== e && (e = a, b.trigger("orientationchange"));
}
var b = a(window), c, d, e;
a.event.special.orientationchange = c = {
setup: function() {
...
return a.orientation = d(), b.apply(this, arguments);
};
}
}, c.orientation = d = function() {
...
this.keepNative = ":jqmData(role='none'), :jqmData(role='nojs')" + (c.keepNative ? ", " + c.keepNative : "");
if (this._trigger("beforeCreate") === !1) return;
b.find(":jqmData(role='page'), :jqmData(role='content')").andSelf().each(function() {
a(this).addClass("ui-" + a(this).jqmData("role"));
}), b.find(":jqmData(role='nojs')").addClass("ui-nojs");
var d = b.find(":jqmData(role)").andSelf().each(function() {
var d = a(this), e = d.jqmData("role"), f = d.jqmData("theme");
if (e === "header" || e === "footer") {
d.addClass("ui-bar-" + (f || d.parent(":jqmData(role='page')").jqmData("theme") || "a")), d.attr("role", e === "header" ? "banner" : "contentinfo");
var g = d.children("a"), h = g.hasClass("ui-btn-left"), i = g.hasClass("ui-btn-right");
h || (h = g.eq(0).not(".ui-btn-right").addClass("ui-btn-left").length), i || (i = g.eq(1).addClass("ui-btn-right").length);
if (c.addBackBtn && e === "header" && a(".ui-page").length > 1 && b.jqmData("url") !== a.mobile.path.stripHash(location.hash) && !h && d.jqmData("backbtn") !== !1) {
var j = a("<a href='#' class='ui-btn-left' data-" + a.mobile.ns + "rel='back' data-" + a.mobile.ns + "icon='arrow-l'>" + c.backBtnText + "</a>").prependTo(d);
c.backBtnTheme && j.attr("data-" + a.mobile.ns + "theme", c.backBtnTheme);
}
...
} else e === "content" ? (f && d.addClass("ui-body-" + f), d.attr("role", "main")) : e === "page" && d.addClass("ui-body-" + (f || "c"));
switch (e) {
case "header":
case "footer":
case "page":
...
this._enhanceControls(), b.find(":jqmData(role='button'), .ui-bar > a, .ui-header > a, .ui-footer > a").not(".ui-btn").not(this.keepNative).buttonMarkup(), b.find(":jqmData(role='controlgroup')").controlgroup(), b.find("a:not(.ui-btn):not(.ui-link-inherit)").not(this.keepNative).addClass("ui-link"), b.fixHeaderFooter();
},
...
var d = this.getAttribute("type"), e = b.degradeInputs[d] || "text";
b.degradeInputs[d] && a(this).replaceWith(a("<div>").html(a(this).clone()).html().replace(c._typeAttributeRegex, ' type="' + e + '" data-' + a.mobile.ns + 'type="' + d + '" '));
});
var d = this.element.find("input, textarea, select, button"), e = d.not(this.keepNative), f = d.filter("input[type=text]");
f.length && typeof f[0].autocorrect != "undefined" && f.each(function() {
this.setAttribute("autocorrect", "off"), this.setAttribute("autocomplete", "off");
}), e.filter("[type='radio'], [type='checkbox']").checkboxradio(), e.filter("button, [type='button'], [type='submit'], [type='reset'], [type='image']").button(), e.filter("input, textarea").not("[type='radio'], [type='checkbox'], [type='button'], [type='submit'], [type='reset'], [type='image'], [type='hidden']").textinput(), e.filter("input, select").filter(":jqmData(role='slider'), :jqmData(type='range')").slider(), e.filter("select:not(:jqmData(role='slider'))").selectmenu();
}
});
}(jQuery), function(a, b, c) {
a.extend(a.mobile, {
...
c = c || 0, a.event.special.scrollstart.enabled = !1, setTimeout(function() {
b.scrollTo(0, c), a(document).trigger("silentscroll", {
x: 0,
y: c
});
...
return this.data(b ? a.mobile.ns + b : b, c);
}, a.jqmData = function(b, c, d) {
return a.data(b, c && a.mobile.ns + c, d);
}, a.fn.jqmRemoveData = function(b) {
return this.removeData(a.mobile.ns + b);
}, a.jqmRemoveData = function(b, c) {
return a.removeData(b, c && a.mobile.ns + c);
}, a.jqmHasData = function(b, c) {
return a.hasData(b, c && a.mobile.ns + c);
};
var d = a.find;
a.find = function(b, c, e, f) {
return b = b.replace(/:jqmData\(([^)]*)\)/g, "[data-" + (a.mobile.ns || "") + "$1]"), d.call(this, b, c, e, f);
}, a.extend(a.find, d), a.find.matches = function(b, c) {
...
if (b && b.length) b.focus(); else {
var c = a.find(".ui-title:eq(0)");
c.length ? c.focus() : a.find(i).eq(0).focus();
}
}
function u(b) {
!!g && (!g.closest(".ui-page-active").length || b) && g.removeClass(a.mobile.activeBtnClass), g = null;
}
var c = a(window), d = a("html"), e = a("head"), f = {
get: function(a) {
return a === b && (a = location.hash), f.stripHash(a).replace(/[^\/]*\.[^\/*]+$/, "");
},
getFilePath: function(b) {
var c = "&" + a.mobile.subPageUrlKey;
return b && b.split(c)[0].split(m)[0];
},
set: function(a) {
location.hash = a;
},
origin: "",
setOrigin: function() {
f.origin = f.get(location.protocol + "//" + location.host + location.pathname);
},
makeAbsolute: function(a) {
return f.isPath(window.location.hash) ? f.get() + a : a;
},
isPath: function(a) {
return /\//.test(a);
},
clean: function(a) {
var b = new RegExp("^" + location.protocol + "//" + location.host + location.pathname);
return a.replace(b, "");
},
...
return f.hasProtocol(f.clean(a));
},
hasProtocol: function(a) {
return /^(:?\w+:)/.test(a);
},
isRelative: function(a) {
return /^[^\/|#]/.test(a) && !f.hasProtocol(a);
},
...
h.getNext() && h.clearForward(), h.stack.push({
url: a,
transition: b,
title: c,
page: d
...
directHashChange: function(c) {
var d, e, f;
a.each(h.stack, function(a, b) {
c.currentUrl === b.url && (d = a < h.activeIndex, e = !d, f = a);
}), this.activeIndex = f !== b ? f : this.activeIndex, d ? c.isBack() : e && c.isForward();
},
ignoreNextHashChange: !0
}, i = "[tabindex],a,button:visible,select:visible,input", j = null, k = [], l = !1, m = "&ui-state=dialog", n = e.children("base"), o = location.protocol + "//" + location.host, p = f.get(o + location.pathname), q = p;
if (n.length) {
var r = n.attr("href");
r && (r.search(/^[^:\/]+:\/\/[^\/]+\/?/) === -1 ? r.charAt(0) === "/" ? q = o + r : q = p + r : q = r), q += q.charAt(q.length - 1) === "/" ? " " : "/";
}
var s = a.support.dynamicBaseTag ? {
element: n.length ? n : a("<base>", {
href: q
}).prependTo(e),
set: function(a) {
s.element.attr("href", q + f.get(a));
},
reset: function() {
s.element.attr("href", q);
}
} : b;
f.setOrigin(), a.fn.animationComplete = function(b) {
return a.support.cssTransitions ? a(this).one("webkitAnimationEnd", b) : (setTimeout(b, 0), a(this));
}, a.mobile.updateHash = f.set, a.mobile.path = f, a.mobile.base = s, a.mobile.urlstack = h.stack, a.mobile.urlHistory = h, a.mobile.allowCrossDomainPages = !1, a.mobile.changePage = function(e, i, n, o, p) {
function G() {
i === b && (i = j && j === "dialog" ? "pop" : a.mobile.defaultTransition);
}
function H() {
l = !1, k.length > 0 && a.mobile.changePage.apply(a.mobile, k.pop());
}
function I() {
function l() {
o !== !1 && w && (h.ignoreNextHashChange = !1, f.set(w));
var b = e.jqmData("title") || e.find(".ui-header .ui-title").text();
!!b && F == document.title && (F = b), !D && !E && h.addNew(w, i, F, e), document.title = h.getActive().title, u(), a.mobile.silentScroll(e.jqmData("lastScroll")), t(e), v && v.data("page")._trigger("hide", null, {
nextPage: e
}), e.data("page")._trigger("show", null, {
prevPage: v || a("")
}), a.mobile.activePage = e, B !== null && B.remove(), d.removeClass("ui-mobile-rendering"), H();
}
function m(b) {
a.mobile.pageContainer.addClass(b), k.push(b);
}
function p() {
a.mobile.pageContainer.removeClass(k.join(" ")), k = [];
}
a.mobile.silentScroll();
var b = c.scrollTop(), j = [ "flip" ], k = [];
w.indexOf("&" + a.mobile.subPageUrlKey) > -1 && (e = a(":jqmData(url='" + w + "')")), v && (v.jqmData("lastScroll", b).jqmData("lastClicked", g), v.data("page")._trigger("beforehide", null, {
nextPage: e
})), e.data("page")._trigger("beforeshow", null, {
prevPage: v || a("")
}), i && i !== "none" ? (a.mobile.pageLoading(!0), a.inArray(i, j) >= 0 && m("ui-mobile-viewport-perspective"), m("ui-mobile-viewport-transitioning"), v && v.addClass(i + " out " + (n ? "reverse" : "")), e.addClass(a.mobile.activePageClass + " " + i + " in " + (n ? "reverse" : "")), e.animationComplete(function() {
e.add(v).removeClass("out in reverse " + i), v && v.removeClass(a.mobile.activePageClass), l(), p();
})) : (a.mobile.pageLoading(!0), v && v.removeClass(a.mobile.activePageClass), e.addClass(a.mobile.activePageClass), l());
}
function J() {
if (j || e.jqmData("role") === "dialog") w = h.getActive().url + m, j && (e.attr("data-" + a.mobile.ns + "role", j), j = null);
e.page();
}
var q = a.type(e) === "array", r = a.type(e) === "object", v = q ? e[0] : a.mobile.activePage;
e = q ? e[1] : e;
var w = a.type(e) === "string" ? f.stripHash(e) : "", x = w, y, z = "get", A = !1, B = null, C = h.getActive(), D = !1, E = !1, F = document.title;
if (C && h.stack.length > 1 && C.url === w && !q && !r) return;
if (l) {
k.unshift(arguments);
return;
}
l = !0, p && h.directHashChange({
currentUrl: w,
isBack: function() {
E = !(D = !0), n = !0, i = i || C.transition;
},
isForward: function() {
E = !(D = !1), i = i || h.getActive().transition;
}
}), r && e.url && (w = e.url, y = e.data, z = e.type, A = !0, y && z === "get" && (a.type(y) === "object" && (y = a.param(y)), w += "?" + y, y = b)), s && s.reset(), window.document.activeElement && a(window.document.activeElement || "").add("input:focus, textarea:focus, select:focus").blur();
if (w) e = a(":jqmData(url='" + w + "')"), x = f.getFilePath(w); else {
var K = e.attr("data-" + a.mobile.ns + "url"), L = f.getFilePath(K);
K !== L && (x = L);
}
G(), e.length && !A ? (x && s && s.set(x), J(), I()) : (e.length && (B = e), a.mobile.pageLoading(), a.ajax({
url: x,
type: z,
data: y,
dataType: "html",
success: function(b) {
var c = a("<div></div>"), d, g = b.match(/<title[^>]*>([^<]*)/) && RegExp.$1, h = new RegExp(".*(<[^>]+\\bdata-" + a.mobile.ns + "role=[\"']?page[\"']?[^>]*>).*"), i = new RegExp("\\bdata-" + a.mobile.ns + "url=[\"']?([^\"'>]*)[\"']?");
h.test(b) && RegExp.$1 && i.test(RegExp.$1) && RegExp.$1 && (d = RegExp.$1), d ? (s && s.set(d), w = x = f.getFilePath(d)) : s && s.set(x), c.get(0).innerHTML = b, e = c.find(":jqmData(role='page'), :jqmData(role='dialog')").first(), g && (F = g);
if (!a.support.dynamicBaseTag) {
var j = f.get(x);
e.find("[src], link[href], a[rel='external'], :jqmData(ajax='false'), a[target]").each(function() {
var b = a(this).is("[href]") ? "href" : "src", c = a(this).attr(b);
c = c.replace(location.protocol + "//" + location.host + location.pathname, ""), /^(\w+:|#|\/)/.test(c) || a(this).attr(b, j + c);
});
}
e.attr("data-" + a.mobile.ns + "url", x).appendTo(a.mobile.pageContainer), J(), setTimeout(function() {
I();
}, 0);
},
error: function() {
a.mobile.pageLoading(!0), u(!0), s && s.set(f.get()), H(), a("<div class='ui-loader ui-overlay-shadow ui-body-e ui-corner-all'><h1>" + a.mobile.pageLoadErrorMessage + "</h1></div>").css({
display: "block",
opacity: .96,
...
if (!a.mobile.ajaxEnabled || !a.mobile.ajaxFormsEnabled || a(this).is(":jqmData(ajax='false')")) return;
var c = a(this).attr("method"), d = f.clean(a(this).attr("action")), e = a(this).attr("target");
if (f.isExternal(d) || e) return;
f.isRelative(d) && (d = f.makeAbsolute(d)), a.mobile.changePage({
url: d.length && d || f.get(),
type: c.length && c.toLowerCase() || "get",
...
}), a("a").live("click", function(b) {
var c = a(this), d = c.attr("href") || "#", e = f.hasProtocol(d), h = f.clean(d), i = c.is("[rel='external']"), k = f.isEmbeddedPage(h), l = a.mobile.allowCrossDomainPages && location.protocol === "file:" && h.search(/^https?:/) != -1, m = f.isExternal(h) && !l || i && !k, n = c.is("[target]"), o = c.is(":jqmData(ajax='false')"), p = f.stripHash(h) == a.mobile.activePage.jqmData("url");
if (c.is(":jqmData(rel='back')")) return window.history.back(), !1;
if (h.replace(f.get(), "") == "#" || p) {
b.preventDefault();
return;
}
g = c.closest(".ui-btn");
if (m || o || n || !a.mobile.ajaxEnabled || !a.mobile.ajaxLinksEnabled) {
window.setTimeout(function() {
u(!0);
}, 200);
return;
}
var q = c.jqmData("transition"), r = c.jqmData("direction"), s = r && r === "reverse" || c.jqmData("back");
j = c.attr("data-" + a.mobile.ns + "rel"), f.isRelative(h) && !e && (h = f.makeAbsolute(h)), h = f.stripHash(h), a.mobile.changePage(h, q, s), b.preventDefault();
}), c.bind("hashchange", function(c, d) {
var e = f.stripHash(location.hash), g = a.mobile.urlHistory.stack.length === 0 ? !1 : b;
if (!a.mobile.hashListeningEnabled || !h.ignoreNextHashChange) {
h.ignoreNextHashChange || (h.ignoreNextHashChange = !0);
return;
}
if (h.stack.length > 1 && e.indexOf(m) > -1) {
...
var i = function() {
e = a.mobile.urlHistory.getActive().page;
};
h.directHashChange({
currentUrl: e,
isBack: i,
...
e ? a.mobile.changePage(e, g, b, !1, !0) : a.mobile.changePage(a.mobile.firstPage, g, !0, !1, !0);
});
}(jQuery), function(a, b) {
a.fn.fixHeaderFooter = function(b) {
return a.support.scrollTop ? this.each(function() {
var b = a(this);
b.jqmData("fullscreen") && b.addClass("ui-page-fullscreen"), b.find(".ui-header:jqmData(position='fixed')").addClass("ui-header-fixed ui-fixed-inline fade"), b.find(".ui-footer:jqmData(position='fixed')").addClass("ui-footer-fixed ui-fixed-inline fade");
}) : this;
}, a.fixedToolbars = function() {
function p(b) {
!d && c == "overlay" && (f || a.fixedToolbars.hide(!0), a.fixedToolbars.startShowTimer());
}
function q(a) {
var b = 0;
if (a) {
var c = a.offsetParent, d = document.body;
b = a.offsetTop;
while (a && a != d) b += a.scrollTop || 0, a == c && (b += c.offsetTop, c = a.offsetParent), a = a.parentNode;
}
return b;
}
function r(b) {
var c = a(window).scrollTop(), d = q(b[0]), e = b.css("top") == "auto" ? 0 : parseFloat(b.css("top")), f = window.innerHeight, g = b.outerHeight(), h = b.parents(".ui-page:not(.ui-page-fullscreen)").length, i;
return b.is(".ui-header-fixed") ? (i = c - d + e, i < d && (i = 0), b.css("top", h ? i : c)) : (i = c + f - g - (d - e), b.css("top", h ? i : c + f - g));
}
if (!a.support.scrollTop) return;
var c = "inline", d = !1, e = 100, f, g = "a,input,textarea,select,button,label,.ui-header-fixed,.ui-footer-fixed", h = ".ui-header-fixed:first, .ui-footer-fixed:not(.ui-footer-duplicate):last", i, j = a.support.touch, k = j ? "touchstart" : "mousedown", l = j ? "touchend" : "mouseup", m = null, n = !1, o = !0;
return a(function() {
a(document).bind("vmousedown", function(a) {
o && (m = c);
}).bind("vclick", function(b) {
if (o) {
if (a(b.target).closest(g).length) return;
n || (a.fixedToolbars.toggle(m), m = null);
}
}).bind("scrollstart", function(b) {
n = !0, m == null && (m = c);
var e = m == "overlay";
d = e || !!f, d && (a.fixedToolbars.clearShowTimer(), e && a.fixedToolbars.hide(!0));
}).bind("scrollstop", function(b) {
if (a(b.target).closest(g).length) return;
n = !1, d && (d = !1, a.fixedToolbars.startShowTimer()), m = null;
}).bind("silentscroll", p), a(window).bind("resize", p);
}), a(".ui-page").live("pagebeforeshow", function(b, c) {
var d = a(b.target), e = d.find(":jqmData(role='footer')"), f = e.data("id"), g = c.prevPage;
prevFooter = g && g.find(":jqmData(role='footer')");
var h = prevFooter.jqmData("id") === f;
f && h && (i = e, r(i.removeClass("fade in out").appendTo(a.mobile.pageContainer)));
}), a(".ui-page").live("pageshow", function(b, c) {
var d = a(this);
i && i.length && setTimeout(function() {
r(i.appendTo(d).addClass("fade")), i = null;
}, 500), a.fixedToolbars.show(!0, this);
}), {
show: function(b, d) {
a.fixedToolbars.clearShowTimer(), c = "overlay";
var e = d ? a(d) : a.mobile.activePage ? a.mobile.activePage : a(".ui-page-active");
return e.children(h).each(function() {
var c = a(this), d = a(window).scrollTop(), e = q(c[0]), f = window.innerHeight, g = c.outerHeight(), h = c.is(".ui-header-fixed") && d <= e + g || c.is(".ui-footer-fixed") && e <= d + f;
c.addClass("ui-fixed-overlay").removeClass("ui-fixed-inline"), !h && !b && c.animationComplete(function() {
c.removeClass("in");
}).addClass("in"), r(c);
});
},
hide: function(b) {
c = "inline";
var d = a.mobile.activePage ? a.mobile.activePage : a(".ui-page-active");
return d.children(h).each(function() {
var c = a(this), d = c.css("top");
d = d == "auto" ? 0 : parseFloat(d), c.addClass("ui-fixed-inline").removeClass("ui-fixed-overlay");
if (d < 0 || c.is(".ui-header-fixed") && d != 0) if (b) c.css("top", 0); else if (c.css("top") !== "auto" && parseFloat(c.css("top")) !== 0) {
var e = "out reverse";
c.animationComplete(function() {
c.removeClass(e), c.css("top", 0);
}).addClass(e);
}
});
},
...
f = b, a.fixedToolbars.show.apply(null, c);
}, e);
},
clearShowTimer: function() {
f && clearTimeout(f), f = b;
},
toggle: function(b) {
return b && (c = b), c == "overlay" ? a.fixedToolbars.hide() : a.fixedToolbars.show();
},
...
_create: function() {
var c = this, d = this.element, e = d.closest("form,fieldset,:jqmData(role='page')").find("label").filter("[for=" + d[0].id + "]"), f = d.attr("type"), g = "ui-icon-" + f + "-on", h = "ui-icon-" + f + "-off";
...
checkedicon: g,
uncheckedicon: h
}), this.options.theme || (this.options.theme = this.element.jqmData("theme")), e.buttonMarkup({
theme: this.options.theme,
icon: this.element.parents(":jqmData(type='horizontal')").length ? b : h,
shadow: !1
}), d.add(e).wrapAll("<div class='ui-" + f + "'></div>"), e.bind({
vmouseover: function() {
...
return c._cacheVals(), d.attr("checked", f === "radio" && !0 || !d.is(":checked")), c._updateAll(), !1;
}
}), d.bind({
vmousedown: function() {
this._cacheVals();
...
refresh: function() {
var b = this.element, c = this.label, d = c.find(".ui-icon");
b[0].checked ? (c.addClass(a.mobile.activeBtnClass), d.addClass(this.checkedicon).removeClass(this.uncheckedicon)) : (c.removeClass(a.mobile.activeBtnClass), d.removeClass(this.checkedicon).addClass(this.uncheckedicon)), b.is(":disabled") ? this.disable() : this.enable();
},
disable: function() {
this.element.attr("disabled", !0).parent().addClass("ui-disabled");
},
enable: function() {
...
_create: function() {
var b = this.element, c = this.options, d = c.theme, e;
if (!d) {
var f = this.element.closest("[class*='ui-bar-'],[class*='ui-body-']");
d = f.length ? /ui-(bar|body)-([a-z])/.exec(f.attr("class"))[2] : "c";
}
e = " ui-body-" + d, a("label[for=" + b.attr("id") + "]").addClass("ui-input-text"), b.addClass("ui-input-text ui-body-" + c.theme);
var g = b;
if (b.is("[type='search'],:jqmData(type='search')")) {
g = b.wrap('<div class="ui-input-search ui-shadow-inset ui-btn-corner-all ui-btn-shadow ui-icon-searchfield' + e + '"></div>').parent();
var h = a('<a href="#" class="ui-input-clear" title="clear text">clear text</a>').tap(function(a) {
b.val("").focus(), b.trigger("change"), h.addClass("ui-input-clear-hidden"), a.preventDefault();
}).appendTo(g).buttonMarkup({
icon: "delete",
iconpos: "notext",
corners: !0,
shadow: !0
...
function i() {
b.val() == "" ? h.addClass("ui-input-clear-hidden") : h.removeClass("ui-input-clear-hidden");
}
i(), b.keyup(i);
} else b.addClass("ui-corner-all ui-shadow-inset" + e);
b.focus(function() {
g.addClass("ui-focus");
}).blur(function() {
...
if (b.is("textarea")) {
var j = 15, k = 100, l = function() {
var a = b[0].scrollHeight, c = b[0].clientHeight;
c < a && b.css({
height: a + j
});
}, m;
b.keyup(function() {
clearTimeout(m), m = setTimeout(l, k);
});
}
},
disable: function() {
...
_create: function() {
var b = this, c = this.options, d = this.element.wrap("<div class='ui-select'>"), e = d.attr("id"), f = a("label[for=" + e + "]").addClass("ui-select"), g = d[0].selectedIndex == -1 ? 0 : d[0].selectedIndex, h = (b.options.nativeMenu ? a("<div/>") : a("<a>", {
href: "#",
role: "button",
id: k,
"aria-haspopup": "true",
"aria-owns": l
})).text(a(d[0].options.item(g)).text()).insertBefore(d).buttonMarkup({
theme: c.theme,
icon: c.icon,
iconpos: c.iconpos,
inline: c.inline,
...
}), i = b.isMultiple = d[0].multiple;
c.nativeMenu && window.opera && window.opera.version && d.addClass("ui-select-nativeonly");
if (!c.nativeMenu) var j = d.find("option"), k = e + "-button", l = e + "-menu", m = d.closest(".ui-page"), n = /ui-btn-up-([a-z])/.exec(h.attr("class"))[1], o = a("<div data-" + a.mobile.ns + "role='dialog' data-" + a.mobile.ns + "theme='" + c.menuPageTheme + "'>" + "<div data-" + a.mobile.ns + "role='header'>" + "<div class='ui-title'>" + f.text() + "</div>" + "</div>" + "<div data-" + a.mobile.ns + "role='content'></div>" + "</div>").appendTo(a.mobile.pageContainer).page(), p = o.find(".ui-content"), q = o.find(".ui-header a"), r = a("<div>", {
...
}).insertAfter(r), t = a("<ul>", {
"class": "ui-selectmenu-list",
id: l,
role: "listbox",
"aria-labelledby": k
}).attr("data-" + a.mobile.ns + "theme", n).appendTo(s), u = a("<div>", {
"class": "ui-header ui-bar-" + n
}).prependTo(s), v = a("<h1>", {
"class": "ui-title"
}).appendTo(u), w = a("<a>", {
text: c.closeText,
href: "#",
"class": "ui-btn-left"
}).attr("data-" + a.mobile.ns + "iconpos", "notext").attr("data-" + a.mobile.ns + "icon", "delete").appendTo(u).buttonMarkup(), x;
i && (b.buttonCount = a("<span>").addClass("ui-li-count ui-btn-up-c ui-btn-corner-all").hide().appendTo(h)), c.disabled && this.disable(), d.change(function() {
b.refresh();
}), a.extend(b, {
select: d,
optionElems: j,
...
headerTitle: v,
placeholder: ""
}), c.nativeMenu ? d.appendTo(h).bind("vmousedown", function(b) {
...
}) : (b.refresh(), d.attr("tabindex", "-1").focus(function() {
a(this).blur(), h.focus();
}), h.bind("vclick keydown", function(c) {
if (c.type == "vclick" || c.keyCode && (c.keyCode === a.mobile.keyCode.ENTER || c.keyCode === a.mobile.keyCode.SPACE)) b.open(), c.preventDefault();
}), t.attr("role", "listbox").delegate(".ui-li>a", "focusin", function() {
a(this).attr("tabindex", "0");
}).delegate(".ui-li>a", "focusout", function() {
a(this).attr("tabindex", "-1");
}).delegate("li:not(.ui-disabled, .ui-li-divider)", "vclick", function(c) {
var e = d[0].selectedIndex, f = t.find("li:not(.ui-li-divider)").index(this), g = b.optionElems.eq(f)[0];
g.selected = i ? !g.selected : !0, i && a(this).find(".ui-icon").toggleClass("ui-icon-checkbox-on", g.selected).toggleClass("ui-icon-checkbox-off", !g.selected), e !== f && d.trigger("change"), i || b.close(), c.preventDefault();
}).keydown(function(b) {
var c = a(b.target), d = c.closest("li");
switch (b.keyCode) {
case 38:
var e = d.prev();
return e.length && (c.blur().attr("tabindex", "-1"), e.find("a").first().focus()), !1;
case 40:
var f = d.next();
return f.length && (c.blur().attr("tabindex", "-1"), f.find("a").first().focus()), !1;
case 13:
case 32:
return c.trigger("vclick"), !1;
}
}), r.bind("vclick", function(a) {
b.close();
...
var i = a(this), j = i.parent(), k = i.text(), l = "<a href='#'>" + k + "</a>", m = [], n = [];
if (j.is("optgroup")) {
var p = j.attr("label");
a.inArray(p, e) === -1 && (f.push("<li data-" + a.mobile.ns + "role='list-divider'>" + p + "</li>"), e.push(p));
}
if (!this.getAttribute("value") || k.length == 0 || i.jqmData("placeholder")) c.hidePlaceholderMenuItems && m.push("ui-selectmenu-placeholder"), d = b.placeholder = k;
this.disabled && (m.push("ui-disabled"), n.push("aria-disabled='true'")), f.push("<li data-" + a.mobile.ns + "icon='" + g + "' class='" + m.join(" ") + "' " + n.join(" ") + ">" + l + "</li>");
}), b.list.html(f.join(" ")), b.list.find("li").attr({
role: "option",
tabindex: "-1"
...
refresh: function(b) {
var c = this, d = this.element, e = this.isMultiple, f = this.optionElems = d.find("option"), g = f.filter(":selected"), h = g.map(function() {
return f.index(this);
}).get();
!c.options.nativeMenu && (b || d[0].options.length != c.list.find("li").length) && c._buildList(), c.button.find(".ui-btn-text").text(function() {
return e ? g.length ? g.map(function() {
return a(this).text();
}).get().join(", ") : c.placeholder : g.text();
}), e && c.buttonCount[g.length > 1 ? "show" : "hide"]().text(g.length), c.options.nativeMenu || c.list.find("li:not(.ui-li-divider)").removeClass(a.mobile.activeBtnClass).attr("aria-selected", !1).each(function(b) {
if (a.inArray(b, h) > -1) {
var c = a(this).addClass(a.mobile.activeBtnClass);
c.find("a").attr("aria-selected", !0), e && c.find(".ui-icon").removeClass("ui-icon-checkbox-off").addClass("ui-icon-checkbox-on");
}
});
},
open: function() {
function i() {
b.list.find(".ui-btn-active").focus();
}
if (this.options.disabled || this.options.nativeMenu) return;
var b = this, c = b.list.parent().outerHeight(), d = b.list.parent().outerWidth(), e = a(window).scrollTop(), f = b.button.offset().top, g = window.innerHeight, h = window.innerWidth;
b.button.addClass(a.mobile.activeBtnClass), setTimeout(function() {
b.button.removeClass(a.mobile.activeBtnClass);
}, 300);
if (c > g - 80 || !a.support.scrollTop) e == 0 && f > g && b.thisPage.one("pagehide", function() {
a(this).jqmData("lastScroll", f);
}), b.menuPage.one("pageshow", function() {
a(window).one("silentscroll", function() {
i();
});
}), b.menuType = "page", b.menuPageContent.append(b.list), a.mobile.changePage(b.menuPage, "pop", !1, !0); else {
b.menuType = "overlay", b.screen.height(a(document).height()).removeClass("ui-screen-hidden");
var j = f - e, k = e + g - f, l = c / 2, m = parseFloat(b.list.parent().css("max-width")), n, o;
j > c / 2 && k > c / 2 ? n = f + b.button.outerHeight() / 2 - l : n = j > k ? e + g - c - 30 : e + 30, d < m ? o = (h - d) / 2 : (o = b.button.offset().left + b.button.outerWidth() / 2 - d / 2, o < 30 ? o = 30 : o + d > h && (o = h - d - 30)), b.listbox.append(b.list).removeClass("ui-selectmenu-hidden").css({
top: n,
left: o
}).addClass("in"), i();
}
...
setTimeout(function() {
b.button.focus();
}, 40), b.listbox.removeAttr("style").append(b.list);
}
if (this.options.disabled || !this.isOpen || this.options.nativeMenu) return;
var b = this;
b.menuType == "page" ? (a.mobile.changePage([ b.menuPage, b.thisPage ], "pop", !0, !1), b.menuPage.one("pagehide", c)) : (b.screen.addClass("ui-screen-hidden"), b.listbox.addClass("ui-selectmenu-hidden").removeAttr("style").removeClass("in"), c()), this.isOpen = !1;
},
disable: function() {
...
return this.each(function() {
var d = a(this), e = a.extend({}, a.fn.buttonMarkup.defaults, d.jqmData(), b), f, g = "ui-btn-inner", h;
c && c();
if (!e.theme) {
var i = d.closest("[class*='ui-bar-'],[class*='ui-body-']");
e.theme = i.length ? /ui-(bar|body)-([a-z])/.exec(i.attr("class"))[2] : "c";
}
f = "ui-btn ui-btn-up-" + e.theme, e.inline && (f += " ui-btn-inline"), e.icon && (e.icon = "ui-icon-" + e.icon, e.iconpos = e.iconpos || "left", h = "ui-icon " + e.icon, e.shadow && (h += " ui-icon-shadow")), e.iconpos && (f += " ui-btn-icon-" + e.iconpos, e.iconpos == "notext" && !d.attr("title") && d.attr("title", d.text())), e.corners && (f += " ui-btn-corner-all", g += " ui-btn-corner-all"), e.shadow && (f += " ui-shadow"), d.attr("data-" + a.mobile.ns + "theme", e.theme).addClass(f);
var j = ("<D class='" + g + "'><D class='ui-btn-text'></D>" + (e.icon ? "<span class='" + h + "'></span>" : "") + "</D>").replace(/D/g, e.wrapperEls);
d.wrapInner(j);
});
...
vmousedown: function() {
var b = a(this).attr("data-" + a.mobile.ns + "theme");
a(this).removeClass("ui-btn-up-" + b).addClass("ui-btn-down-" + b);
},
"vmousecancel vmouseup": function() {
var b = a(this).attr("data-" + a.mobile.ns + "theme");
a(this).removeClass("ui-btn-down-" + b).addClass("ui-btn-up-" + b);
},
"vmouseover focus": function() {
var b = a(this).attr("data-" + a.mobile.ns + "theme");
a(this).removeClass("ui-btn-up-" + b).addClass("ui-btn-hover-" + b);
},
"vmouseout blur": function() {
var b = a(this).attr("data-" + a.mobile.ns + "theme");
a(this).removeClass("ui-btn-hover-" + b).addClass("ui-btn-up-" + b);
}
}), c = null;
};
}(jQuery), function(a, b) {
...
_create: function() {
var b = this.element, c = this.options;
this.button = a("<div></div>").text(b.text() || b.val()).buttonMarkup({
theme: c.theme,
icon: c.icon,
iconpos: c.iconpos,
inline: c.inline,
...
shadow: c.shadow,
iconshadow: c.iconshadow
}).insertBefore(b).append(b.addClass("ui-btn-hidden"));
var d = b.attr("type");
d !== "button" && d !== "reset" && b.bind("vclick", function() {
var c = a("<input>", {
type: "hidden",
name: b.attr("name"),
value: b.attr("value")
...
_create: function() {
var b = this, c = this.element, d = c.parents("[class*=ui-bar-],[class*=ui-body-]").eq(0), d = d.length ? d.attr("class").match(/ui-(bar|body)-([a-z])/)[2] : "c", e = this.options.theme ? this.options.theme : d, f = this.options.trackTheme ? this.options.trackTheme : d, g = c[0].nodeName.toLowerCase(), h = g == "select" ? "ui-slider-switch" : "", i = c.attr("id"), j = i + "-label", k = a("[for=" + i + "]").attr("id", j), l = function() {
return g == "input" ? parseFloat(c.val()) : c[0].selectedIndex;
}, m = g == "input" ? parseFloat(c.attr("min")) : 0, n = g == "input" ? parseFloat(c.attr("max")) : c.find("option").length - 1, o = window.parseFloat(c.attr("step") || 1), p = a('<div class="ui-slider ' + h + " ui-btn-down-" + f + ' ui-btn-corner-all" role="application"></div>'), q = a('<a href="#" class="ui-slider-handle"></a>').appendTo(p).buttonMarkup({
corners: !0,
theme: e,
shadow: !0
}).attr({
...
if (g == "select") {
p.wrapInner('<div class="ui-slider-inneroffset"></div>');
var r = c.find("option");
c.find("option").each(function(b) {
var c = b == 0 ? "b" : "a", d = b == 0 ? "right" : "left", e = b == 0 ? " ui-btn-down-" + f : " ui-btn-active";
a('<div class="ui-slider-labelbg ui-slider-labelbg-' + c + e + " ui-btn-corner-" + d + '"></div>').prependTo(p), a('<span class="ui-slider-label ui-slider-label-' + c + e + " ui-btn-corner-" + d + '" role="img">' + a(this).text() + "</span>").prependTo(q);
});
}
k.addClass("ui-slider"), c.addClass(g == "input" ? "ui-slider-input" : "ui-slider-switch").change(function() {
b.refresh(l(), !0);
}).keyup(function() {
b.refresh(l(), !0, !0);
}).blur(function() {
...
if (b.dragging) return b.refresh(a), !1;
}), p.bind("vmousedown", function(a) {
return b.dragging = !0, g === "select" && (b.beforeStart = c[0].selectedIndex), b.refresh(a), !1;
}), p.add(document).bind("vmouseup", function() {
if (b.dragging) {
b.dragging = !1;
if (g === "select") {
b.beforeStart === c[0].selectedIndex && b.refresh(b.beforeStart === 0 ? 1 : 0);
var a = l(), d = Math.round(a / (n - m) * 100);
q.addClass("ui-slider-handle-snapping").css("left", d + "%").animationComplete(function() {
q.removeClass("ui-slider-handle-snapping");
});
}
return !1;
}
}), p.insertAfter(c), this.handle.bind("vmousedown", function() {
a(this).focus();
}).bind("vclick", !1), this.handle.bind("keydown", function(c) {
var d = l();
...
c.preventDefault(), b._keySliding || (b._keySliding = !0, a(this).addClass("ui-state-active"));
}
switch (c.keyCode) {
case a.mobile.keyCode.HOME:
b.refresh(m);
...
b._keySliding && (b._keySliding = !1, a(this).removeClass("ui-state-active"));
}), this.refresh();
},
refresh: function(a, b, c) {
if (this.options.disabled) return;
var d = this.element, e, f = d[0].nodeName.toLowerCase(), g = f === "input" ? parseFloat(d.attr("min")) : 0, h = f === "input" ? parseFloat(d.attr("max")) : d.find("option").length - 1;
if (typeof a == "object") {
var i = a, j = 8;
if (!this.dragging || i.pageX < this.slider.offset().left - j || i.pageX > this.slider.offset().left + this.slider.width() + j) return;
e = Math.round((i.pageX - this.slider.offset().left) / this.slider.width() * 100);
} else a == null && (a = f === "input" ? parseFloat(d.val()) : d[0].selectedIndex), e = (parseFloat(a) - g) / (h - g) * 100;
if (isNaN(e)) return;
e < 0 && (e = 0), e > 100 && (e = 100);
var k = Math.round(e / 100 * (h - g)) + g;
k < g && (k = g), k > h && (k = h), !(e > 60 && f === "select"), this.handle.css("left", e + "%"), this.handle.attr({
"aria-valuenow": f === "input" ? k : d.find("option").eq(k).attr("value"),
"aria-valuetext": f === "input" ? k : d.find("option").eq(k).text(),
title: k
}), f === "select" && (k === 0 ? this.slider.addClass("ui-slider-switch-a").removeClass("ui-slider-switch-b") : this.slider.addClass("ui-slider-switch-b").removeClass("ui-slider-switch-a")), c || (f === "input" ? d.val(k) : d[0].selectedIndex = k, b || d.trigger("change"));
},
enable: function() {
...
_create: function() {
var b = this.element, c = this.options, d = b.addClass("ui-collapsible-contain"), e = b.find(c.heading).eq(0), f = d.wrapInner('<div class="ui-collapsible-content"></div>').find(".ui-collapsible-content"), g = b.closest(":jqmData(role='collapsible-set')").addClass("ui-collapsible-set");
e.is("legend") && (e = a('<div role="heading">' + e.html() + "</div>").insertBefore(e), e.next().remove()), e.insertBefore(f), e.addClass("ui-collapsible-heading").append('<span class="ui-collapsible-heading-status"></span>').wrapInner('<a href="#" class="ui-collapsible-heading-toggle"></a>').find("a:eq(0)").buttonMarkup({
shadow: !g.length,
corners: !1,
iconPos: "left",
icon: "plus",
...
icon: "plus",
theme: c.iconTheme
}), g.length ? d.jqmData("collapsible-last") && e.find("a:eq(0), .ui-btn-inner").addClass("ui-corner-bottom") : e.find("a:eq(0)").addClass("ui-corner-all").find(".ui-btn-inner").addClass("ui-corner-all"), d.bind("collapse", function(a) {
a.isDefaultPrevented() || (a.preventDefault(), e.addClass("ui-collapsible-heading-collapsed").find(".ui-collapsible-heading-status").text(c.expandCueText), e.find(".ui-icon").removeClass("ui-icon-minus").addClass("ui-icon-plus"), f.addClass("ui-collapsible-content-collapsed").attr("aria-hidden", !0), d.jqmData("collapsible-last") && e.find("a:eq(0), .ui-btn-inner").addClass("ui-corner-bottom"));
}).bind("expand", function(a) {
a.isDefaultPrevented() || (a.preventDefault(), e.removeClass("ui-collapsible-heading-collapsed").find(".ui-collapsible-heading-status").text(c.collapseCueText), e.find(".ui-icon").removeClass("ui-icon-plus").addClass("ui-icon-minus"), f.removeClass("ui-collapsible-content-collapsed").attr("aria-hidden", !1), d.jqmData("collapsible-last") && e.find("a:eq(0), .ui-btn-inner").removeClass("ui-corner-bottom"));
}).trigger(c.collapsed ? "collapse" : "expand");
if (g.length && !g.jqmData("collapsiblebound")) {
g.jqmData("collapsiblebound", !0).bind("expand", function(b) {
a(this).find(".ui-collapsible-contain").not(a(b.target).closest(".ui-collapsible-contain")).not("> .ui-collapsible-contain .ui-collapsible-contain").trigger("collapse");
});
var h = g.find(":jqmData(role=collapsible)");
h.first().find("a:eq(0)").addClass("ui-corner-top").find(".ui-btn-inner").addClass("ui-corner-top"), h.last().jqmData("collapsible-last", !0);
}
e.bind("vmouseup", function(a) {
e.is(".ui-collapsible-heading-collapsed") ? d.trigger("expand") : d.trigger("collapse"), a.preventDefault();
}).bind("vclick", !1);
}
});
}(jQuery), function(a, b) {
...
return this.each(function() {
function g(a) {
a.removeClass("ui-btn-corner-all ui-shadow").eq(0).addClass(e[0]).end().filter(":last").addClass(e[1]).addClass("ui-controlgroup-last");
}
var c = a.extend({
direction: a(this).jqmData("type") || "vertical",
shadow: !1
}, b), d = a(this).find(">legend"), e = c.direction == "horizontal" ? [ "ui-corner-left", "ui-corner-right" ] : [ "ui-corner-top", "ui-corner-bottom" ], f = a(this).find("input:eq(0)").attr("type");
d.length && (a(this).wrapInner('<div class="ui-controlgroup-controls"></div>'), a('<div role="heading" class="ui-controlgroup-label">' + d.html() + "</div>").insertBefore(a(this).children(0)), d.remove()), a(this).addClass("ui-corner-all ui-controlgroup ui-controlgroup-" + c.direction), g(a(this).find(".ui-btn")), g(a(this).find(".ui-btn-inner")), c.shadow && a(this).addClass("ui-shadow");
});
};
}(jQuery), function(a, b) {
...
a.addClass("ui-listview"), b.inset && a.addClass("ui-listview-inset ui-corner-all ui-shadow"), this._itemApply(a, a), this.refresh(!0);
},
_itemApply: function(b, c) {
c.find(".ui-li-count").addClass("ui-btn-up-" + (b.jqmData("counttheme") || this.options.countTheme) + " ui-btn-corner-all"), c.find("h1, h2, h3, h4, h5, h6").addClass("ui-li-heading"), c.find("p, dl").addClass("ui-li-desc"), b.find("li").find(">img:eq(0), >:first>img:eq(0)").addClass("ui-li-thumb").each(function() {
a(this).closest("li").addClass(a(this).is(".ui-li-icon") ? "ui-li-has-icon" : "ui-li-has-thumb");
});
var d = c.find(".ui-li-aside");
d.length && d.each(function(b, c) {
a(c).prependTo(a(c).parent());
});
if (a.support.cssPseudoElement || !a.nodeName(c[0], "ol")) return;
},
...
var c = this.options, d = this.element, e = this, f = d.jqmData("dividertheme") || c.dividerTheme, g = d.children("li"), h = a.support.cssPseudoElement || !a.nodeName(d[0], "ol") ? 0 : 1;
h && d.find(".ui-li-dec").remove(), g.each(function(i) {
var j = a(this), k = "ui-li";
if (!b && j.hasClass("ui-li")) return;
var l = j.jqmData("theme") || c.theme, m = j.find(">a");
if (m.length) {
var n = j.jqmData("icon");
j.buttonMarkup({
wrapperEls: "div",
shadow: !1,
corners: !1,
iconpos: "right",
icon: m.length > 1 || n === !1 ? !1 : n || "arrow-r",
theme: l
}), m.first().addClass("ui-link-inherit");
if (m.length > 1) {
k += " ui-li-has-alt";
var p = m.last(), q = d.jqmData("splittheme") || p.jqmData("theme") || c.splitTheme;
p.appendTo(j).attr("title", p.text()).addClass("ui-li-link-alt").empty().buttonMarkup({
shadow: !1,
corners: !1,
theme: l,
icon: !1,
...
theme: q,
iconpos: "notext",
icon: d.jqmData("spliticon") || p.jqmData("icon") || c.splitIcon
}));
}
} else j.jqmData("role") === "list-divider" ? (k += " ui-li-divider ui-btn ui-bar-" + f, j.attr("role", "heading"), h && (h = 1)) : k += " ui-li-static ui-body-" + l;
c.inset && (i === 0 && (k += " ui-corner-top", j.add(j.find(".ui-btn-inner")).find(".ui-li-link-alt").addClass("ui-corner-tr").end().find(".ui-li-thumb").addClass("ui-corner-tl"), j.next().next().length && e._removeCorners(j.next())), i === g.length - 1 && (k += " ui-corner-bottom", j.add(j.find(".ui-btn-inner")).find(".ui-li-link-alt").addClass("ui-corner-br").end().find(".ui-li-thumb").addClass("ui-corner-bl"), j.prev().prev().length && e._removeCorners(j.prev())));
if (h && k.indexOf("ui-li-divider") < 0) {
var r = j.is(".ui-li-static:first") ? j : j.find(".ui-link-inherit");
r.addClass("ui-li-jsnumbering").prepend("<span class='ui-li-dec'>" + h++ + ". </span>");
}
j.add(j.find(".ui-btn-inner")).addClass(k), b || e._itemApply(d, j);
});
},
...
var b = this.element, c = b.closest(".ui-page"), d = c.jqmData("url"), e = this.options, f = this, g = c.find(":jqmData(role='footer')").jqmData("id");
a(b.find("li>ul, li>ol").toArray().reverse()).each(function(c) {
var h = a(this), i = h.parent(), j = a(h.prevAll().toArray().reverse()), j = j.length ? j : a("<span>" + a.trim(i.contents()[0].nodeValue) + "</span>"), k = j.first().text(), l = d + "&" + a.mobile.subPageUrlKey + "=" + f._idStringEscape(k + " " + c), m = h.jqmData("theme") || e.theme, n = h.jqmData("counttheme") || b.jqmData("counttheme") || e.countTheme, p = h.wrap("<div data-" + a.mobile.ns + "role='page'><div data-" + a.mobile.ns + "role='content'></div></div>").parent().before("<div data-" + a.mobile.ns + "role='header' data-" + a.mobile.ns + "theme='" + e.headerTheme + "'><div class='ui-title'>" + k + "</div></div>").after(g ? a("<div data-" + a.mobile.ns + "role='footer'  data-" + a.mobile.ns + "id='" + g + "'>") : "").parent().attr("data-" + a.mobile.ns + "url", l).attr("data-" + a.mobile.ns + "theme", m).attr("data-" + a.mobile.ns + "count-theme", n).appendTo(a.mobile.pageContainer);
p.page();
var q = i.find("a:first");
q.length || (q = a("<a></a>").html(j || k).prependTo(i.empty())), q.attr("href", "#" + l);
}).listview();
}
});
}(jQuery), function(a, b) {
a.mobile.listview.prototype.options.filter = !1, a.mobile.listview.prototype.options.filterPlaceholder = "Filter items...", a(":jqmData(role='listview')").live("listviewcreate", function() {
...
}).attr("data-" + a.mobile.ns + "type", "search").bind("keyup change", function() {
var c = this.value.toLowerCase(), d = b.children();
d.show();
if (c) {
var e = !1, f;
for (var g = d.length; g >= 0; g--) f = a(d[g]), f.is("li:jqmData(role=list-divider)") ? (e || f.hide(), e = !1) : f.text().toLowerCase().indexOf(c) === -1 ? f.hide() : e = !0;
}
}).appendTo(d).textinput();
a(this).jqmData("inset") && d.addClass("ui-listview-filter-inset"), d.insertBefore(b);
});
}(jQuery), function(a, b) {
...
var c;
b.type == "vclick" ? c = a(b.target).closest("a") : c = a(b.target).closest("form"), c.length && !c.jqmData("transition") && c.attr("data-" + a.mobile.ns + "transition", a.mobile.urlHistory.getActive().transition).attr("data-" + a.mobile.ns + "direction", "reverse");
});
},
close: function() {
window.history.back();
...
}), e || c.addClass("ui-navbar-noicons"), d.buttonMarkup({
corners: !1,
shadow: !1,
iconpos: e
}), c.delegate("a", "vclick", function(b) {
d.not(".ui-state-persist").removeClass(a.mobile.activeBtnClass), a(this).addClass(a.mobile.activeBtnClass);
});
}
});
}(jQuery), function(a, b) {
...
if (!f) if (d.length <= 5) for (var h in e) e[h] == d.length && (f = h); else f = "a";
g = e[f], a(this).addClass("ui-grid-" + f), d.filter(":nth-child(" + g + "n+1)").addClass("ui-block-a"), g > 1 && d.filter(":nth-child(" + g + "n+2)").addClass("ui-block-b"), g > 2 && d.filter(":nth-child(3n+3)").addClass("ui-block-c"), g > 3 && d.filter(":nth-child(4n+4)").addClass("ui-block-d"), g > 4 && d.filter(":nth-child(5n+5)").addClass("ui-block-e");
});
};
}(jQuery), function(a, b, c) {
var d = a("html"), e = a("head"), f = a(b);
a(b.document).trigger("mobileinit");
if (!a.mobile.gradeA()) return;
d.addClass("ui-mobile ui-mobile-rendering"), a.mobile.metaViewportContent && !e.find("meta[name='viewport']").length ? a("<meta>", {
name: "viewport",
content: a.mobile.metaViewportContent
}).prependTo(e) : c;
var g = a.mobile.loadingMessage ? a("<div class='ui-loader ui-body-a ui-corner-all'><span class='ui-icon ui-icon-loading spin'></span><h1>" + a.mobile.loadingMessage + "</h1>" + "</div>") : c;
typeof g == "undefined" && alert(a.mobile.loadingMessage), a.extend(a.mobile, {
pageLoading: function(c) {
if (c) d.removeClass("ui-loading"); else {
if (a.mobile.loadingMessage) {
var e = a("." + a.mobile.activeBtnClass).first();
typeof g == "undefined" && alert(a.mobile.loadingMessage), g.appendTo(a.mobile.pageContainer).css({
top: a.support.scrollTop && a(b).scrollTop() + a(b).height() / 2 || e.length && e.offset().top || 100
});
}
...
var b = a(this);
b.jqmData("url") || b.attr("data-" + a.mobile.ns + "url", b.attr("id"));
}), a.mobile.firstPage = b.first(), a.mobile.pageContainer = b.first().parent().addClass("ui-mobile-viewport"), a.mobile.pageLoading(), !a.mobile.hashListeningEnabled || !a.mobile.path.stripHash(location.hash) ? a.mobile.changePage(a.mobile.firstPage, !1, !0, !1, !0) : f.trigger("hashchange", [ !0 ]);
}
}), a(a.mobile.initializePage), f.load(a.mobile.silentScroll);
}(jQuery, this), jQuery(document).ready(function() {
var a = jQuery("#mobile-logo");
a.length && a.attr("src", a.data("src"));
});
...
a === 0 ? VideoControls.autoPlayCallback ? VideoControls.autoPlayCallback() : VideoControls.setAutoPlayEnabled(!1) : a === 2 && VideoControls.setAutoPlayEnabled(!1);
},
...
} else if (a === 0 && c) this.playing = !1, this.save(), VideoControls.autoPlayEnabled ? setTimeout(function() {
b.checkVideoComplete();
}, 500) : VideoControls.setAutoPlayEnabled(!1), this.analyticsActivity && (this.analyticsActivity.parameters["Percent (end)"] = this.dPercentLastSaved, Analytics.trackActivityEnd(this.analyticsActivity), this.analyticsActivity = null); else if (a === 2 && c) this.playing = !1, this.getSecondsWatchedSinceSave() > 1 && this.save(), VideoControls.autoPlayEnabled ? setTimeout(function() {
b.checkVideoComplete();
}, 500) : VideoControls.setAutoPlayEnabled(!1), this.analyticsActivity && (this.analyticsActivity.parameters["Percent (end)"] = this.dPercentLastSaved, Analytics.trackActivityEnd(this.analyticsActivity), this.analyticsActivity = null); else if (a === 1) {
