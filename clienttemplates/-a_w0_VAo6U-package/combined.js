Socrates.Data["-a_w0_VAo6U"] = {
    Events: [
        new Socrates.Question({
            ...
            id: 1,
            correctData: {numerator: "3", denominator: "5"},
            "qtip-position": {
                my: "top left",
                adjust: { x: 280, y: 95 }
            }
